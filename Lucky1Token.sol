...
contract L1T is ERC20, Ownable {
    ...
    address public immutable USDT = address(0x4DBCdF9B62e891a7cec5A2568C3F4FAF9E8Abe2b); //USDT
    ...
    uint256 public totalFees = USDTRewardsFee.add(liquidityFee).add(marketingFee).add(dPrizeFee).add(mPrizeFee).add(yPrizeFee);
    ...
    function setUSDTRewardsFee(uint256 value) external onlyOwner{
        ...
        totalFees = USDTRewardsFee.add(liquidityFee).add(marketingFee).add(dPrizeFee).add(mPrizeFee).add(yPrizeFee);
    }
